 ...
 * @property User $user
 */
class Look extends \common\modules\core\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return \common\modules\core\models\aq\LookQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \common\modules\core\models\aq\LookQuery(get_called_class());
    }

    /**
     * Adds one more unit to the value.
     * @return bool
     */
