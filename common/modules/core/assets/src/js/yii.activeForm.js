(function ($) {
    ...
    var events = {
        ...
        /**
         * beforeAjaxSubmit event
         */
        beforeAjaxSubmit: 'beforeAjaxSubmit',
        /**
         * ajaxSubmitComplete event
         */
        ajaxSubmitComplete: 'ajaxSubmitComplete',
        /**
         * ajaxSubmitError event
         */
        ajaxSubmitError: 'ajaxSubmitError',
        /**
         * ajaxSubmitSuccess event is triggered after form was submitted via ajax
         */
        ajaxSubmitSuccess: 'ajaxSubmitSuccess'
    };
            ...
            if (errorInputs.length) {
                ...
                if (data.settings.ajaxSubmit) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function (jqXHR, settings) {
                            $form.trigger(events.beforeAjaxSubmit, [jqXHR, settings]);
                        },
                        success: function (data) {
                            $form.trigger(events.ajaxSubmitSuccess, [data]);
                        },
                        error: function () {
                            $form.trigger(events.ajaxSubmitError, []);
                        }
                    });
                } else {
                    $form.submit();
